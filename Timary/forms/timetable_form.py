...
class TimetableForm(FlaskForm):
    ...
    hour = IntegerField('Часы', validators=[NumberRange(min=0, max=23)], render_kw={"placeholder": "ЧЧ"})
    minute = IntegerField('Минуты', validators=[NumberRange(min=0, max=59)], render_kw={"placeholder": "ММ"})
